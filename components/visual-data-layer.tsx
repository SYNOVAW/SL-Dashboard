      ...
      <CardContent className="space-y-8">
        ...
        <div>
          <div className="flex items-center gap-4 mb-6">
            <h3 className="font-semibold text-card-foreground font-inter text-center">Price Movement</h3>
        ...
        {/* Volume Chart */}
        <div>
          <h3 className="font-semibold text-card-foreground mb-6 font-inter text-center">Trading Volume</h3>
        ...
        {/* Sentiment Heat Bar */}
        <div>
          <h3 className="font-semibold text-card-foreground mb-6 font-inter text-center">Sentiment Timeline</h3>
