    ...
    <Card className="w-full bg-card border-border/50 rounded-xl soft-shadow">
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg font-semibold text-foreground font-inter">Market Analysis</CardTitle>
      ...
      <CardContent className="space-y-8">
        ...
        <div>
          <div className="flex items-center gap-4 mb-6">
            <h3 className="font-semibold text-foreground font-inter">Price Movement</h3>
        ...
        {/* Volume Chart */}
        <div>
          <h3 className="font-semibold text-foreground mb-6 font-inter">Trading Volume</h3>
        ...
        {/* Sentiment Heat Bar */}
        <div>
          <h3 className="font-semibold text-foreground mb-6 font-inter">Sentiment Timeline</h3>
